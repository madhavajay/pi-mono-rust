...
pub fn apply_env_api_keys_for_availability(auth_storage: &mut AuthStorage) {
    apply_env_key_if_missing(auth_storage, "anthropic", env_var_non_empty("ANTHROPIC_OAUTH_TOKEN"));
    apply_env_key_if_missing(auth_storage, "anthropic", env_var_non_empty("ANTHROPIC_API_KEY"));
    ...
    apply_env_key_if_missing(auth_storage, "cerebras", env_var_non_empty("CEREBRAS_API_KEY"));
    apply_env_key_if_missing(auth_storage, "xai", env_var_non_empty("XAI_API_KEY"));
    apply_env_key_if_missing(auth_storage, "openrouter", env_var_non_empty("OPENROUTER_API_KEY"));
    apply_env_key_if_missing(auth_storage, "zai", env_var_non_empty("ZAI_API_KEY"));
    apply_env_key_if_missing(auth_storage, "mistral", env_var_non_empty("MISTRAL_API_KEY"));
